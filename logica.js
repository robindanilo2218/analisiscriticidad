...
function renderizarTablaMto() {
    ...
    let c1 = document.getElementById('datosMtoFiltroCol1').value; let v1 = document.getElementById('datosMtoFiltroVal1').value; let c2 = document.getElementById('datosMtoFiltroCol2').value; let v2 = document.getElementById('datosMtoFiltroVal2').value; let c3 = document.getElementById('datosMtoFiltroCol3').value; let v3 = document.getElementById('datosMtoFiltroVal3').value;
